...
(defun pickup (object)
  (cond ((member object
        ...
        (t '(you cannot get that.)))) ;; else

(defun inventory ()
  (cons 'items- (objects-at 'body *objects* *object-locations*))) ;; 'items- je symbol moglo je i : umesto -
...
;; @param lst Lista
;; @param caps da li je rec pocetak recenice ili treba capitalized
;; @param lit disabluje kapitalizaciju u slucaju "
